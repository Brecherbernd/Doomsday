...
if not ni.loaded then
	...
	local function loadAll()
		...
		-- ni.licensing = require(dir.."addon\\core\\licensing.lua");
		ni.lib = {};	
		...
		ni.showintstatus = function()
			if ni.vars.profiles.interrupt then
				...
				elseif de then
					ni.frames.floatingtext:message("Unterbrechungen: \124cff00ff00Aktiviert")
				else
				...
				elseif de then
					ni.frames.floatingtext:message("Unterbrechungen: \124cffff0000Deaktiviert")
				else
		...
		ni.updatefollow = function(enabled)
			if enabled then
				...
				elseif de then
					ni.frames.floatingtext:message("Automatisches Folgen: \124cff00ff00Aktiviert")
				else
				...
				elseif de then
					ni.frames.floatingtext:message("Automatisches Folgen: \124cffff0000Deaktiviert")
				else
