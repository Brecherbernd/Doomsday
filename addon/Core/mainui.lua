...
local de = GetLocale() == "deDE" or false;
local main_ui = {};
local Localization = {
	Assistant = "Rotation Assistant",
	Support = "Supported by Trojan",
...
if ru then
	...
	Localization.Support = "При поддержке Trojan"
	...
	Localization.Stream = "Режим стрима:"
...
if de then
	Localization.Assistant = "Rotation Assistent"
	Localization.Support = "Unterstützt von Trojan"
	Localization.Primary = "Wählen Sie die primäre Rotation:"
	Localization.Secondary = "Wählen Sie die sekundäre Rotation:"
	Localization.GenericProfile = "Wählen Sie die generische Rotation:"
	Localization.None = "Keine"
	Localization.Resource = "Ressourcenverfolgung"
	Localization.All = "Alle"
	Localization.Reload = "Neu laden nach Änderung"
	Localization.Global = "toggle oder global"
	Localization.GUI = "GUI Toggle:"
	Localization.PrimaryKey = "Primärtoggle:"
	Localization.SecondaryKey = "Sekundärtoggle:"
	Localization.Generic = "Generisch Toggle:"
	Localization.Interrupt = "Unterbrechungstoggle:"
	Localization.Follow = "Folgeeinheit & Toggle"
	Localization.GlobalDev = "Globale Variable:"
	Localization.Dev = "Entwickleroptionen:"
	Localization.ReloadDev = "Neu laden"
	Localization.Console = "Konsole"
	Localization.Contact = "Kontakt:"
	Localization.Rotation = "Rotationseinstellungen"
	Localization.MainSettings = "Haupteinstellungen"
	Localization.ResourceTrack = "Ressourcenverfolgung"
	Localization.CreatureTrack = "Kreaturenverfolgung"
	Localization.Close = "Schließen"
	Localization.Lockpicking = "Schlossknacken"
	Localization.Herbs = "Kräuter"
	Localization.Minerals = "Mineralien"
	Localization.DisarmTrap = "Falle entschärfen"
	Localization.Open = "Öffnen"
	Localization.Treasure = "Schatztruhen"
	Localization.CloseTrack = "Schließen"
	Localization.ArmTrap = "Falle legen"
	Localization.QuickOpen = "Schnell öffnen"
	Localization.CalcifiedElvenGems = "Verkalkte elfische Edelsteine"
	Localization.QuickClose = "Schnell schließen"
	Localization.OpenTinkering = "Öffnen durch Basteln"
	Localization.OpenKneeling = "Öffnen /kneel"
	Localization.OpenAttacking = "Öffnen durch Angriff"
	Localization.Gahzridian = "Gahz'ridian"
	Localization.Blasting = "Sprengstoff"
	Localization.PvPOpen = "Öffnen im PvP"
	Localization.PvPClose = "Schließen im PvP"
	Localization.Fishing = "Angeln"
	Localization.Inscription = "Inschriftenkunde"
	Localization.OpenFromVehicle = "Öffnen aus Fahrzeug"
	Localization.CreatureTrackingToggles = "Kreaturenverfolgung"
	Localization.Beasts = "Wildtiere"
	Localization.Dragons = "Drachen"
	Localization.Demons = "Dämonen"
	Localization.Elementals = "Elementare"
	Localization.Giants = "Riesen"
	Localization.Undead = "Untote"
	Localization.Humanoids = "Humanoiden"
	Localization.Critters = "Kleintiere"
	Localization.Machines = "Maschinen"
	Localization.Slimes = "Schleime"
	Localization.Totem = "Totems"
	Localization.NonCombatPet = "Haustier"
	Localization.GasCloud = "Gaswolke"
	Localization.Latency = "Latenz (" .. ni.vars.latency .. " MS)"
	Localization.LatencySlider = "Latenz"
	Localization.AreaofEffectToggle = "Flächeneffekt-Toggle:"
	Localization.PauseRotationModifier = "Rotation pausieren:"
	Localization.CDToggle = "CD-Toggle:"
	Localization.CustomToggle = "Benutzerdefiniertes Toggle:"
	Localization.MainTankOverride = "Haupttank überschreiben:"
	Localization.Enabled = "Aktiviert:"
	Localization.OffTankOverride = "Offtank überschreiben:"
	Localization.IsMelee = "Nahkampf:"
	Localization.All = "Alle Klassen"
	Localization.Coin = "Icon entfernen:"
	Localization.Stream = "Streaming Mode:"
	Localization.LeftClick = "|cffC0C0C0Linksklick:|r Öffne das Hauptmenü."
	Localization.RightClick = "|cffC0C0C0Rechtsklick:|r Prüfe updates."
	Localization.MidleClick = "|cffC0C0C0Midle click:|r Öffne denn Discord Server."
end
local ui = {
	icon = {
		x = 75.70,
...
local function moveIcon(self)
	...
	centerX, centerY = (centerX / math.sqrt(centerX ^ 2 + centerY ^ 2)) * 76,
...
boxes.resource_lockpicking = CreateCheckBox(resourcesettings, -130, -66, bitwise.hasbit(currentresources, 0x1),
	checkbox_clicked, 0x1);
CreateDropDownText(resourcesettings, Localization.Herbs, -15, -88, "LEFT")
boxes.resource_herbs = CreateCheckBox(resourcesettings, -130, -86, bitwise.hasbit(currentresources, 0x2),
	checkbox_clicked, 0x2);
CreateDropDownText(resourcesettings, Localization.Minerals, -15, -108, "LEFT")
boxes.resource_minerals = CreateCheckBox(resourcesettings, -130, -106, bitwise.hasbit(currentresources, 0x4),
	checkbox_clicked, 0x4);
CreateDropDownText(resourcesettings, Localization.DisarmTrap, -15, -128, "LEFT")
boxes.resource_disarmtrap = CreateCheckBox(resourcesettings, -130, -126, bitwise.hasbit(currentresources, 0x8),
	checkbox_clicked, 0x8);
CreateDropDownText(resourcesettings, Localization.Open, -15, -148, "LEFT")
boxes.resource_open = CreateCheckBox(resourcesettings, -130, -146, bitwise.hasbit(currentresources, 0x10),
	checkbox_clicked, 0x10);
CreateDropDownText(resourcesettings, Localization.Treasure, -15, -168, "LEFT")
boxes.resource_treasure = CreateCheckBox(resourcesettings, -130, -166, bitwise.hasbit(currentresources, 0x20),
	checkbox_clicked, 0x20);
CreateDropDownText(resourcesettings, Localization.CloseTrack, -15, -188, "LEFT")
boxes.resource_close = CreateCheckBox(resourcesettings, -130, -186, bitwise.hasbit(currentresources, 0x80),
	checkbox_clicked, 0x80);
CreateDropDownText(resourcesettings, Localization.ArmTrap, -15, -208, "LEFT")
boxes.resource_armtrap = CreateCheckBox(resourcesettings, -130, -206, bitwise.hasbit(currentresources, 0x100),
	checkbox_clicked, 0x100);
CreateDropDownText(resourcesettings, Localization.QuickOpen, -15, -228, "LEFT")
boxes.resource_quickopen = CreateCheckBox(resourcesettings, -130, -226, bitwise.hasbit(currentresources, 0x200),
	checkbox_clicked, 0x200);
CreateDropDownText(resourcesettings, Localization.CalcifiedElvenGems, -15, -248, "LEFT")
boxes.resource_calcifiedelvengems = CreateCheckBox(resourcesettings, -130, -246, bitwise.hasbit(currentresources, 0x40),
	checkbox_clicked, 0x40);
CreateDropDownText(resourcesettings, Localization.QuickClose, 130, -28, "LEFT")
boxes.resource_quickclose = CreateCheckBox(resourcesettings, 15, -26, bitwise.hasbit(currentresources, 0x400),
	checkbox_clicked, 0x400);
CreateDropDownText(resourcesettings, Localization.OpenTinkering, 130, -48, "LEFT")
boxes.resource_opentinkering = CreateCheckBox(resourcesettings, 15, -46, bitwise.hasbit(currentresources, 0x800),
	checkbox_clicked, 0x800);
CreateDropDownText(resourcesettings, Localization.OpenKneeling, 130, -68, "LEFT")
boxes.resource_openkneeling = CreateCheckBox(resourcesettings, 15, -66, bitwise.hasbit(currentresources, 0x1000),
	checkbox_clicked, 0x1000);
CreateDropDownText(resourcesettings, Localization.OpenAttacking, 130, -88, "LEFT")
boxes.resource_openattacking = CreateCheckBox(resourcesettings, 15, -86, bitwise.hasbit(currentresources, 0x2000),
	checkbox_clicked, 0x2000);
CreateDropDownText(resourcesettings, Localization.Gahzridian, 130, -108, "LEFT")
boxes.resource_gahzridian = CreateCheckBox(resourcesettings, 15, -106, bitwise.hasbit(currentresources, 0x4000),
	checkbox_clicked, 0x4000);
CreateDropDownText(resourcesettings, Localization.Blasting, 130, -128, "LEFT")
boxes.resource_blasting = CreateCheckBox(resourcesettings, 15, -126, bitwise.hasbit(currentresources, 0x8000),
	checkbox_clicked, 0x8000);
CreateDropDownText(resourcesettings, Localization.PvPOpen, 130, -148, "LEFT")
boxes.resource_pvpopen = CreateCheckBox(resourcesettings, 15, -146, bitwise.hasbit(currentresources, 0x10000),
	checkbox_clicked, 0x10000);
CreateDropDownText(resourcesettings, Localization.PvPClose, 130, -168, "LEFT")
boxes.resource_pvpclose = CreateCheckBox(resourcesettings, 15, -166, bitwise.hasbit(currentresources, 0x20000),
	checkbox_clicked, 0x20000);
CreateDropDownText(resourcesettings, Localization.Fishing, 130, -188, "LEFT")
boxes.resource_fishing = CreateCheckBox(resourcesettings, 15, -186, bitwise.hasbit(currentresources, 0x40000),
	checkbox_clicked, 0x40000);
CreateDropDownText(resourcesettings, Localization.Inscription, 130, -208, "LEFT")
boxes.resource_inscription = CreateCheckBox(resourcesettings, 15, -206, bitwise.hasbit(currentresources, 0x80000),
	checkbox_clicked, 0x80000);
CreateDropDownText(resourcesettings, Localization.OpenFromVehicle, 130, -228, "LEFT")
boxes.resource_openfromvehicle = CreateCheckBox(resourcesettings, 15, -226, bitwise.hasbit(currentresources, 0x100000),
	checkbox_clicked, 0x100000);
...
cboxes.dragons = CreateCheckBox(creaturesettings, -104, -85, bitwise.hasbit(currentcreatures, 0x2), checkbox_clickedc,
	0x2);
CreateDropDownText(creaturesettings, Localization.Demons, 8, -107, "LEFT")
cboxes.demons = CreateCheckBox(creaturesettings, -104, -105, bitwise.hasbit(currentcreatures, 0x4), checkbox_clickedc,
	0x4);
CreateDropDownText(creaturesettings, Localization.Elementals, 8, -127, "LEFT")
cboxes.elementals = CreateCheckBox(creaturesettings, -104, -125, bitwise.hasbit(currentcreatures, 0x8), checkbox_clickedc,
	0x8);
CreateDropDownText(creaturesettings, Localization.Giants, 8, -147, "LEFT")
cboxes.giants = CreateCheckBox(creaturesettings, -104, -145, bitwise.hasbit(currentcreatures, 0x10), checkbox_clickedc,
	0x10);
CreateDropDownText(creaturesettings, Localization.Undead, 8, -167, "LEFT")
cboxes.undead = CreateCheckBox(creaturesettings, -104, -165, bitwise.hasbit(currentcreatures, 0x20), checkbox_clickedc,
	0x20);
CreateDropDownText(creaturesettings, Localization.Humanoids, 110, -27, "LEFT")
cboxes.humanoids = CreateCheckBox(creaturesettings, -2, -25, bitwise.hasbit(currentcreatures, 0x40), checkbox_clickedc,
	0x40);
CreateDropDownText(creaturesettings, Localization.Critters, 110, -47, "LEFT")
cboxes.critters = CreateCheckBox(creaturesettings, -2, -45, bitwise.hasbit(currentcreatures, 0x80), checkbox_clickedc,
	0x80);
CreateDropDownText(creaturesettings, Localization.Machines, 110, -67, "LEFT")
cboxes.machines = CreateCheckBox(creaturesettings, -2, -65, bitwise.hasbit(currentcreatures, 0x100), checkbox_clickedc,
	0x100);
CreateDropDownText(creaturesettings, Localization.Slimes, 110, -87, "LEFT")
cboxes.slimes = CreateCheckBox(creaturesettings, -2, -85, bitwise.hasbit(currentcreatures, 0x200), checkbox_clickedc,
	0x200);
CreateDropDownText(creaturesettings, Localization.Totem, 110, -107, "LEFT")
cboxes.totem = CreateCheckBox(creaturesettings, -2, -105, bitwise.hasbit(currentcreatures, 0x400), checkbox_clickedc,
	0x400);
CreateDropDownText(creaturesettings, Localization.NonCombatPet, 110, -127, "LEFT")
cboxes.noncombatpet = CreateCheckBox(creaturesettings, -2, -125, bitwise.hasbit(currentcreatures, 0x800),
	checkbox_clickedc, 0x800);
CreateDropDownText(creaturesettings, Localization.GasCloud, 110, -147, "LEFT")
cboxes.gascloud = CreateCheckBox(creaturesettings, -2, -145, bitwise.hasbit(currentcreatures, 0x1000), checkbox_clickedc,
	0x1000);
...
dimbutton:SetScript("OnClick", function()
	ni.functions.open("https://discord.gg/c6GZKjVhxw")
end);
...
CreateDropDownText(settings, Localization.Coin, -15, -10);
CreateCheckBox(settings, 50, -8, ni.vars.coin, function(self)
	if self:GetChecked() then
		ni.vars.coin = true;
		ReloadUI();
	else
...
CreateDropDownText(settings, Localization.Stream, -15, -30);
CreateCheckBox(settings, 50, -28, ni.vars.stream, function(self)
	if self:GetChecked() then
		ni.vars.stream = true;
		ReloadUI();
	else
		ni.vars.stream = false;
		ReloadUI();
	end
end);
...
function MiniMapLDB:OnClick(button)
    ...
    if button == "RightButton" then
        ni.functions.open("https://github.com/svenbledt/NiHub_Trojan/releases")
    end 	
