local GetLocale, GetTime, IsLeftShiftKeyDown, GetCurrentKeyBoardFocus, IsLeftControlKeyDown, IsLeftAltKeyDown, IsRightShiftKeyDown, IsRightControlKeyDown, IsRightAltKeyDown =
		GetLocale, GetTime, IsLeftShiftKeyDown, GetCurrentKeyBoardFocus, IsLeftControlKeyDown, IsLeftAltKeyDown,
		IsRightShiftKeyDown, IsRightControlKeyDown, IsRightAltKeyDown
...
if de then
	Localization.Enabled = "\124cff00ff00Aktiviert"
	Localization.Disabled = "\124cffff0000Deaktiviert"
end
local rotation = {
	started = false,
	profile = {},
		...
		if ni.vars.profiles.enabled then
			if ni.rotation.cdmod() and GetTime() - cdtogglemod > 0.5 then
				...
				if ni.vars.stream then
					...
					print("\124cffFFC300CD: " .. cd_str);
				end
				if (ni.vars.combat.aoe or ni.vars.combat.cd) and not ni.vars.stream then
				...
				elseif not ni.vars.combat.aoe and not ni.vars.combat.cd or ni.vars.stream then
